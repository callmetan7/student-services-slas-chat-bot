...
# School info, wheres, cafeteria, admins office, mostly wheres 
    ...
    response('The cafeteria is beside the multipurpose room', ['where', 'is', 'the', 'cafeteria'], required_words=['where', 'cafeteria'])

    response('My name is Madison. How may I help you.', ['what', 'is', 'your', 'name'], required_words=['your', 'name'])
    
    response('The lost and found room is beside the kids playground outside', ['where', 'is', 'the', 'lost', 'found', 'and'], required_words=['lost'])
    ...
    response("The head of school is Ms.Faustina, and the principle is Mr.Jamal", ["who", 'is', 'the', 'principle'], required_words=['principle'])
    response("Don't worry about it.", ["sorry", "sry"])
    response("To find out about the school's contact info you can visit this link: https://www.laschina.org/contact", ['how', 'can', 'i', 'contact', 'the', 'school'], required_words=['contact', 'school'] )
    # Ignored Responses
    ignoreResponse(' ', ['slas,' 'is', 'a', 'bad', 'school'], required_words=['slas', 'bad'])
    ...
    response("Please do not swear here",  ["fuck", "shit", "wtf", "tf", "bitch"],required_words = ["fuck", "shit", "wtf", "tf", "bitch"], single_response=True) 
    response("Don't worry about it.", ["sorry", "sry"])
